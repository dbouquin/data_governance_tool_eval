...
| [DKAN](https://getdkan.org/) (Drupal-based open data portal based on CKAN) | [2.20.5 (Apr 2025)](https://github.com/GetDKAN/dkan/releases/tag/2.20.5) | GNU General Public License 2.0 | Self-Hosted | Drupal-based Open Data Platform | High (Maintained by [CivicActions](https://getdkan.org/)) | Used by various government agencies for open data portals |
...
|-----------|-----------------|------------------|------------------|----------------|-----------------|------------------------|-----------------|
| Apache Atlas | LS | LS | LS | Only applicable to cloud services | FS | [File, Kerberos, LDAP](https://atlas.apache.org/1.1.0/Atlas-Authentication.html), [SSL, Service Authentication, SPNEGO-based HTTP Authentication](https://atlas.apache.org/1.1.0/Security.html) | Not explicitly compliant but can be used to achieve compliance with GDPR, HIPAA, ISO 27001 |
| AWS Lake Formation/Glue | FS | FS | FS | [Authorized (High)](https://aws.amazon.com/compliance/fedramp/) | FS | [IAM](https://docs.aws.amazon.com/iam/)| [Security compliances listed](https://aws.amazon.com/compliance/iso-certified/) |
