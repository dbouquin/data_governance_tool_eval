...
| AWS (Lake Formation & Glue Data Catalog) | [Varies by service](https://aws.amazon.com/lake-formation/) | [AWS Service Terms](https://aws.amazon.com/service-terms/) (commercial) | Cloud | Centralized Data Lake Governance & Metadata Management | High (Continuously updated AWS service) | [Several US federal agencies](https://aws.amazon.com/government-education/government/) including [FDA](https://aws.amazon.com/solutions/case-studies/fda-case-study/), [Census Bureau](https://aws.amazon.com/solutions/case-studies/us-census-bureau/) |
...
| [Databricks Unity Catalog](https://www.databricks.com/product/unity-catalog) | [Continuously updated](https://www.databricks.com/product/unity-catalog) | [Databricks Terms](https://www.databricks.com/legal/terms-of-use) (commercial with open source components) | Cloud/Self-Hosted | Unified Data & AI Asset Governance | High (Integrated with Databricks Lakehouse Platform) | Limited information on federal usage, but [used by several government agencies](https://www.databricks.com/solutions/industries/public-sector) |
...
| [DKAN](https://getdkan.org/) | [2.20.5 (Apr 2025)](https://github.com/GetDKAN/dkan/releases/tag/2.20.5) | GNU General Public License 2.0 | Self-Hosted | Drupal-based Open Data Platform | High (Maintained by [CivicActions](https://getdkan.org/)) | Used by various government agencies for open data portals |
...
| Tool Name | GDPR Compliance | HIPAA Compliance | ISO 27001 | FedRAMP Status | Data Encryption | Authentication Methods |
|-----------|-----------------|------------------|------------------|----------------|-----------------|------------------------|
| Apache Atlas | PS | PS |  | Only applicable to cloud services | PS | LDAP, Kerberos, Basic Auth |
| AWS Lake Formation/Glue | FS | FS |  | Authorized (High) | FS | IAM, SAML, SSO, MFA |
| CKAN | PS | PS |  | U | PS | OAuth2, LDAP, Basic Auth |
| Collibra Data Intelligence Platform | FS | FS |  | [Authorized (Moderate)](https://www.collibra.com/resources/collibra-and-fedramp) | FS | SSO, OIDC, SAML, Basic Auth |
| Databricks Unity Catalog | FS | FS |  | PS (In Process) | FS | SAML, OAuth, SSO |
| DataHub | PS | PS |  | U | PS | OIDC, SAML, Basic Auth |
| [dbt](https://www.getdbt.com/security) | FS | FS | FS | U | FS | OAuth, SSO, Basic Auth |
| DKAN | PS | PS |  | U | PS | OAuth2, LDAP, Basic Auth |
| Great Expectations | PS | PS |  | U | PS | Basic Auth, API Keys, OAuth (in GX Cloud) |
| OpenMetadata | PS | PS |  | U | PS | Google SSO, Okta SSO, OIDC, Auth0, Azure SSO, Amazon Cognito, OneLogin |
